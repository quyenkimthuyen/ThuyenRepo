...
from data_loader import load_eurusd_m15, get_train_window_indices, get_week_indices
...
def full_strategy_dict(s: MinedStrategy) -> dict:
  ...
  base.update({
    ...
    "partial_runner_trail_r": float(getattr(s, "partial_runner_trail_r", 0.0) or 0.0),
  ...
  for week_start, week_end in tqdm(weeks, desc="Export WF"):
    ...
    for tr in trades:
      ...
      signals.append({
        ...
        "partial_runner_trail_r": float(getattr(strat, "partial_runner_trail_r", 0.0) or 0.0),
