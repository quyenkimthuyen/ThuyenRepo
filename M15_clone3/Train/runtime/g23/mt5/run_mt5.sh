...
start() {
  ...
  docker run -d --name "$NAME" \
    -p 13400:3000 -p 13401:3001 -p 18401:8001 \
  ...
  ' || true
  echo "Started. Web VNC: http://$(hostname -I | awk '{print $1}'):13400  (mt5 / mt5pass)"
...
status() {
  ...
  echo "VNC: http://$(hostname -I | awk '{print $1}'):13400  user=mt5 pass=mt5pass"
