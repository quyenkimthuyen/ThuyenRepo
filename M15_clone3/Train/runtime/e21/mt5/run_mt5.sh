...
start() {
  ...
  docker run -d --name "$NAME" \
    -p 13300:3000 -p 13301:3001 -p 18301:8001 \
  ...
  ' || true
  echo "Started. Web VNC: http://$(hostname -I | awk '{print $1}'):13300  (mt5 / mt5pass)"
...
status() {
  ...
  echo "VNC: http://$(hostname -I | awk '{print $1}'):13300  user=mt5 pass=mt5pass"
