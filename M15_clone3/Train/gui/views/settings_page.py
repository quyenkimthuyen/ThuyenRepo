...
def render(embedded: bool = False):
  ...
  if is_gbp:
    mining_help = (
      ...
      "Săn WR>80 R>80 RR=1: `gbp_fill_hit80`. "
      "Tin cậy chỉ số: `gbp_fill_reliable`. "
      "A/B TP: `gbp_fill_wk5_rr1` / `gbp_fill_wk5_rr15` / `gbp_fill_wk5_rr2`. "
    ...
    mining_help = (
      ...
      "Săn WR>80 R>80: hướng B `eur_fill_rr1_hit` (TP 1.0 + cổng hit80). "
      "Tin cậy chỉ số: `eur_fill_reliable`. "
      "A/B TP: `eur_fill_wk5_rr1` / `eur_fill_wk5_rr15` / `eur_fill_wk5_rr2`. "
  ...
  if reset_pipe:
    st.caption("KB đã khóa sẽ **không bị xóa**. Học thêm epoch (không reset) vẫn chạy được.")
