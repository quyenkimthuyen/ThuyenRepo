...
export const CONTEXT_DOC_SECTIONS = [
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['Lọc tín hiệu', 'AI Signals chấm điểm 0–100 — thanh Min score'],
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'Sau mỗi lần scan Strategies, engine tự chấm từng signal 0–100. Dùng slider Min score để lọc setup đẹp trước khi xem Chart hoặc quyết định có nên mô phỏng lệnh.',
      },
      ...
      },
      {
        type: 'callout',
        variant: 'warn',
        text: 'Lọc Min score chỉ ảnh hưởng danh sách hiển thị ở đây. Simulation vẫn dùng TOÀN BỘ signal từ scan — muốn mô phỏng ít tín hiệu hơn thì scan với cài đặt chặt hơn hoặc tắt strategy yếu.',
      },
      {
        type: 'callout',
        variant: 'info',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: 'callout',
        variant: 'tip',
        text: 'Chạy Strategies (Ctrl+3) trước để có tín hiệu, hoặc Simulation sẽ quét lại. Sau đó xem Statistics / Reports; nếu cần đánh giá rủi ro chuỗi thua → Optimizer tab Monte Carlo.',
      },
    ],
  },
  {
