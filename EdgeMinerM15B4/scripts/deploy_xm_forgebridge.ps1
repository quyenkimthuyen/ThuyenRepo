...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15B4.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15B4Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15b4"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15b4"
$BridgeSubdirLive = "bridge_m15b4"
$BridgeSubdirSim = "bridge_sim_m15b4"
$EaNameLive = "ForgeBridgeM15B4"
$EaNameSim = "ForgeBridgeM15B4Sim"
$EaFolder = "EdgeMinerM15B4"
$EaMagicLive = 20261004
$EaMagicSim = 20262004
$IsBoth = ($Mode -eq "Both")
...
function New-EurusdM15Chart([string]$DataPath) {
  ...
  if ($templates.Count -eq 0) {
    ...
    $forgeExpertPattern = '(?s)<expert>\s*name=(?:ForgeBridgeM15B4Sim|ForgeBridgeM15B4|ForgeBridgeM15Sim|ForgeBridgeM15|ForgeBridgeH1Sim|ForgeBridgeH1|ForgeBridge)\b.*?</expert>\s*'
...
function Get-ForgeFamilyPattern {
  return 'name=(?:ForgeBridgeM15B4Sim|ForgeBridgeM15B4|ForgeBridgeM15Sim|ForgeBridgeM15|ForgeBridgeH1Sim|ForgeBridgeH1|ForgeBridge)\b'
}
...
function Restart-BridgeService {
  ...
  $commandLine = (
    ...
    "--monitor-port 8805 --bridge-dir `"$ProjectBridge`""
  )
