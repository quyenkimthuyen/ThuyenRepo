> **Clone `B4`** từ EdgeMinerM15 — instance `M15B4` · app/bridge/paper `8541/8805/8806` · folder `bridge_m15b4` · magic `20261004`.
...
M15B4 dùng app/Bridge/Paper `8541/8805/8806`, folder `bridge_m15b4`, Magic `20261004`.
...
App mặc định mở tại `http://127.0.0.1:8541`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
