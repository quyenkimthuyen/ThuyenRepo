...
from data_loader import (
  get_train_window_indices, get_week_indices, load_gbpusd_m15,
...
def main():
  parser = argparse.ArgumentParser(description="Walk-forward GBP/USD backtest")
