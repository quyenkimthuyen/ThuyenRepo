...
**ForexForge** là hệ thống backtest & self-learning cho **GBP/USD khung M15**, gồm:
...
| Bước | Mô tả |
|------|--------|
| 1 | ForgeBridge đồng bộ **GBP/USD M15** từ XM MT5 → cache `data/mt5_gbpusd_m15.parquet` |
...
- Một pair / một timeframe (GBP/USD M15)
