...
BRIDGE_DIR = ROOT / "mt5" / "bridge_m15g23"
BRIDGE_SIM_DIR = ROOT / "mt5" / "bridge_sim_m15g23"
...
DEFAULT_MODEL_ID = ""
DEFAULT_MAGIC = 20261023
DEFAULT_SIM_MAGIC = 20262023
...
def pip_size_from_quotes(*, digits: int | None = None, point: float | None = None) -> float:
  """Estimate 1 pip in price units (GBPUSD 5-digit → 0.0001)."""
