...
_WORKFLOW_STEPS_STATIC: tuple[dict, ...] = (
  ...
  },
  {
    ...
    "title": "Live Bridge",
    "short": "⑤ Live",
    "subtitle": "Roster Live Trade",
    "detail": "Chọn 1–5 model trên **Live Trade → Trade Models**, Start Live · theo dõi Health.",
    "nav_page": "live_trade",
    "learning_tab": None,
  },
)
  ...
  for spec in steps_spec:
    ...
    if sid == 1:
      ...
      if _bridge_roster_ready():
        ...
        progress = state.get("live_notes") or "Chọn roster trên Live Trade → Trade Models rồi Start"
