...
const I18N_MESSAGES = {
  vi: {
    ...
    home: {
      ...
      modeCursor: 'Suy ngẫm với Cursor',
      modeCursorDesc: 'AI trực tiếp trong app · Cursor làm cầu nối',
      cursorSessionStarted: 'Đã kết nối Cursor — bắt đầu suy ngẫm',
    ...
    cursorDirect: {
      badge: 'Qua Cursor',
      finishBtn: 'Hoàn tất & lưu vào bản đồ',
      thinking: 'Cursor đang suy ngẫn…',
      bridgeTitle: 'Cần chạy Cursor bridge',
      bridgeIntro:
        'Mode này chat trực tiếp trong app. Một server Node cục bộ (Cursor SDK) làm cầu nối — không cần tài khoản ChatGPT.',
      bridgeSteps:
        '1. cd server && npm install\n2. export CURSOR_API_KEY=...\n3. npm start',
      bridgeUrlLabel: 'URL bridge',
      bridgeRetry: 'Thử lại',
      bridgeClose: 'Đóng',
      bridgeOk: 'Bridge sẵn sàng',
      bridgeNoKey: 'Chưa có CURSOR_API_KEY trên server',
      bridgeNoSdk: 'Chưa cài @cursor/sdk — chạy npm install trong server/',
      bridgeUnreachable: 'Không kết nối được bridge',
      sendFailed: 'Gửi thất bại — kiểm tra bridge đang chạy',
      exportFailed: 'Không xuất được JSON — thử lại hoặc chat thêm vài lượt',
      finishSuccess: 'Đã lưu phiên vào bản đồ suy nghĩ',
      finishMinMessages: 'Hãy trò chuyện thêm ít nhất một lượt trước khi lưu',
      docsHint: 'Chi tiết: docs/CURSOR_BRIDGE.md',
    },
    aiAssist: {
      badge: 'Qua ChatGPT',
    ...
    forest: {
      ...
      created: 'Tạo',
      updated: 'Cập nhật',
      evidenceType: 'Nguồn ghi nhận',
      evidence: 'Bằng chứng',
      evidence_direct_quote: 'Lời bạn nói',
      evidence_paraphrase: 'Diễn giải từ lời bạn',
      evidence_imported: 'Từ ChatGPT (có trích dẫn)',
      evidence_rule_match: 'App đoán từ từ khóa',
      evidence_inferred: 'Suy diễn',
      evidence_legacy: 'Dữ liệu cũ',
    ...
    test: {
      aria: 'Thử nghiệm',
      title: 'Thử nghiệm',
      desc: 'Kịch bản mẫu — suy ngẫm trong app và test hồi quy ChatGPT gián tiếp',
      ...
      aiAssistScenarios: 'ChatGPT gián tiếp ({n})',
      noAiScenarios: 'Chưa có kịch bản ChatGPT',
      runAiAssist: 'Chạy test ChatGPT',
      runAllAiAssist: 'Chạy tất cả',
      aiAssistFlow: 'Luồng kiểm thử',
      aiAssistStep1: 'App sinh prompt reflection + export (theo locale)',
      aiAssistStep2: 'Mô phỏng ChatGPT trả JSON bám lời user',
      aiAssistStep3: 'Import → kiểm tra node, bằng chứng, không suy diễn thêm',
      aiAssistNote: 'Test tự động — không cần mở ChatGPT thật.',
      userDialogue: 'Lời user trong hội thoại ChatGPT',
      chatgptExport: 'JSON mô phỏng ChatGPT',
      expectPresent: 'Phải có sau import',
      expectAbsent: 'Không được có',
      aiAssistResults: 'Kết quả test',
      aiAssistPass: 'Đạt',
      aiAssistFail: 'Không đạt',
      aiAssistFailures: 'Lỗi chi tiết',
      aiAssistSummary: '{passed}/{total} kịch bản đạt',
      aiAssistUnavailable: 'Bộ test ChatGPT chưa sẵn sàng',
      cursorDirectScenarios: 'Cursor trực tiếp ({n})',
      noCursorScenarios: 'Chưa có kịch bản Cursor',
      runCursorDirect: 'Chạy test Cursor',
      runAllCursorDirect: 'Chạy tất cả Cursor',
      cursorDirectFlow: 'Luồng kiểm thử (mock)',
      cursorDirectStep1: 'Mô phỏng phiên cursor_direct + transcript',
      cursorDirectStep2: 'Export JSON (như bridge) → import finish',
      cursorDirectStep3: 'Kiểm tra node, bằng chứng, không rule_match',
      cursorDirectStep4: 'Live sync: node + timeline + Khám phá trước finish',
      cursorDirectNote: 'Mock không cần bridge. Live: node scripts/run-cursor-direct-tests.js --live',
      cursorExport: 'JSON export (mô phỏng bridge)',
      cursorDirectResults: 'Kết quả test Cursor',
      cursorDirectPass: 'Đạt',
      cursorDirectFail: 'Không đạt',
      cursorDirectFailures: 'Lỗi chi tiết',
      cursorDirectSummary: '{passed}/{total} kịch bản Cursor đạt',
      cursorDirectUnavailable: 'Bộ test Cursor chưa sẵn sàng',
    },
    reset: {
    ...
    screenView: {
      ...
      forestChatgptPartial: 'ChatGPT chưa trả đủ chi tiết — thử nhập lại hoặc chạy phân tích mới.',
      forestTreeAiHint: 'ChatGPT',
      forestTreeAiNotes: '{n} ghi chú ChatGPT',
  ...
  en: {
    ...
    home: {
      ...
      modeCursor: 'Reflect with Cursor',
      modeCursorDesc: 'Live AI in the app · Cursor as API bridge',
      cursorSessionStarted: 'Connected to Cursor — reflection started',
      statEntries: 'Entries',
    ...
    cursorDirect: {
      badge: 'Via Cursor',
      finishBtn: 'Finish & save to map',
      thinking: 'Cursor is reflecting…',
      bridgeTitle: 'Cursor bridge required',
      bridgeIntro:
        'This mode chats live in the app. A local Node server (Cursor SDK) acts as the API bridge — no ChatGPT account needed.',
      bridgeSteps:
        '1. cd server && npm install\n2. export CURSOR_API_KEY=...\n3. npm start',
      bridgeUrlLabel: 'Bridge URL',
      bridgeRetry: 'Retry',
      bridgeClose: 'Close',
      bridgeOk: 'Bridge is ready',
      bridgeNoKey: 'CURSOR_API_KEY is not set on the server',
      bridgeNoSdk: '@cursor/sdk not installed — run npm install in server/',
      bridgeUnreachable: 'Cannot reach the bridge',
      sendFailed: 'Send failed — check that the bridge is running',
      exportFailed: 'Could not export JSON — try again or chat a bit more',
      finishSuccess: 'Session saved to your thought map',
      finishMinMessages: 'Chat at least one round before saving',
      docsHint: 'Details: docs/CURSOR_BRIDGE.md',
    },
    aiAssist: {
      badge: 'Via ChatGPT',
    ...
    forest: {
      ...
      evidenceType: 'Source',
      evidence: 'Evidence',
      evidence_direct_quote: 'Your words',
      evidence_paraphrase: 'Paraphrase of your words',
      evidence_imported: 'From ChatGPT (with quote)',
      evidence_rule_match: 'App keyword guess',
      evidence_inferred: 'Inferred',
      evidence_legacy: 'Legacy data',
    ...
    test: {
      aria: 'Test mode',
      title: 'Test',
      desc: 'Sample scenarios — in-app reflection and indirect ChatGPT regression tests',
      ...
      aiAssistScenarios: 'Indirect ChatGPT ({n})',
      noAiScenarios: 'No ChatGPT test scenarios yet',
      runAiAssist: 'Run ChatGPT test',
      runAllAiAssist: 'Run all',
      aiAssistFlow: 'Test flow',
      aiAssistStep1: 'App generates reflection + export prompts (locale-aware)',
      aiAssistStep2: 'Simulated ChatGPT JSON aligned with user dialogue',
      aiAssistStep3: 'Import → verify nodes, evidence, no rule-engine extras',
      aiAssistNote: 'Fully automated — no real ChatGPT session needed.',
      userDialogue: 'User lines in ChatGPT reflection',
      chatgptExport: 'Simulated ChatGPT JSON',
      expectPresent: 'Must exist after import',
      expectAbsent: 'Must not exist',
      aiAssistResults: 'Test results',
      aiAssistPass: 'Pass',
      aiAssistFail: 'Fail',
      aiAssistFailures: 'Failures',
      aiAssistSummary: '{passed}/{total} scenarios passed',
      aiAssistUnavailable: 'ChatGPT test suite not loaded',
      cursorDirectScenarios: 'Cursor direct ({n})',
      noCursorScenarios: 'No Cursor test scenarios yet',
      runCursorDirect: 'Run Cursor test',
      runAllCursorDirect: 'Run all Cursor',
      cursorDirectFlow: 'Test flow (mock)',
      cursorDirectStep1: 'Simulate cursor_direct session + transcript',
      cursorDirectStep2: 'Export JSON (as bridge) → finish import',
      cursorDirectStep3: 'Verify nodes, evidence, no rule_match',
      cursorDirectStep4: 'Live sync: nodes + timeline + Explore before finish',
      cursorDirectNote: 'Mock needs no bridge. Live: node scripts/run-cursor-direct-tests.js --live',
      cursorExport: 'Export JSON (simulated bridge)',
      cursorDirectResults: 'Cursor test results',
      cursorDirectPass: 'Pass',
      cursorDirectFail: 'Fail',
      cursorDirectFailures: 'Failures',
      cursorDirectSummary: '{passed}/{total} Cursor scenarios passed',
      cursorDirectUnavailable: 'Cursor test suite not loaded',
    },
    reset: {
    ...
    screenView: {
      ...
      forestChatgptPartial: 'ChatGPT returned little detail — try importing again or run a new analysis.',
      forestTreeAiHint: 'ChatGPT',
      forestTreeAiNotes: '{n} ChatGPT notes',
