...
def test_eas_use_magic_and_hedging_guards():
  m15 = (M15_ROOT / "mt5" / "Experts" / "ForgeBridgeM15G23.mq5").read_text(encoding="utf-8")
  m15_sim = (M15_ROOT / "mt5" / "Experts" / "ForgeBridgeM15G23Sim.mq5").read_text(encoding="utf-8")
  ...
  assert 'const string INSTANCE_ID = "M15G23"' in m15
  assert 'const string INSTANCE_ID = "M15G23"' in m15_sim
  ...
  for root, live, sim in (
    (M15_ROOT, "ForgeBridgeM15G23", "ForgeBridgeM15G23Sim"),
