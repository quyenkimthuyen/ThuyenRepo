...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM5G33.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM5G33Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m5g33"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m5g33"
$BridgeSubdirLive = "bridge_m5g33"
$BridgeSubdirSim = "bridge_sim_m5g33"
$EaNameLive = "ForgeBridgeM5G33"
$EaNameSim = "ForgeBridgeM5G33Sim"
$EaFolder = "EdgeMinerGBPUSDM5"
$EaMagicLive = 20261081
$EaMagicSim = 20262081
$IsBoth = ($Mode -eq "Both")
