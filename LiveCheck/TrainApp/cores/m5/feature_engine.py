...
FEATURE_PROFILES = {
  ...
  # M5 wall-clock parity with M15 `current` lookbacks (periods ×3)
  "m5_parity": FeatureProfile(
    atr_period=42, rsi_period=42, adx_period=42,
    ema_fast=24, ema_slow=63, ema_trend=150, ema_long=600,
    bb_period=60, zscore_period=60, roc_period=15, sweep_period=60,
    percentile_period=150, warmup=360,
  ),
}
_PROFILE_ALIASES = {
  "existing": "current",
...
class FeatureMatrix:
  ...
  def __init__(self, df: pd.DataFrame, profile: str | None = None):
