...
DEFAULT_TF = str(_CFG.get("tf") or "M5")
...
TARGET_TRADES_PER_WEEK = float(_CFG.get("target_trades_per_week") or 16.0)
MAX_TRADES_PER_DAY = int(_CFG.get("max_trades_per_day") or 5)
