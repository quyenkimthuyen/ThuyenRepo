...
def test_live_desk_renders_signal_wait_section():
  ...
  desk_tab = bridge[bridge.rfind("with tab_desk:"):]
  assert desk_tab.find("_render_stats_section()") < desk_tab.find("_render_signal_wait()")
  assert desk_tab.find("_stats_auto_fragment()") < desk_tab.find("_signal_wait_fragment()")
