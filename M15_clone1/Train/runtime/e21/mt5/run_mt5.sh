...
start() {
  ...
  docker run -d --name "$NAME" \
    -p 13100:3000 -p 13101:3001 -p 18101:8001 \
  ...
  ' || true
  echo "Started. Web VNC: http://$(hostname -I | awk '{print $1}'):13100  (mt5 / mt5pass)"
...
status() {
  ...
  echo "VNC: http://$(hostname -I | awk '{print $1}'):13100  user=mt5 pass=mt5pass"
