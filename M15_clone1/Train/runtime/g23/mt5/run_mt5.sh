...
start() {
  ...
  docker run -d --name "$NAME" \
    -p 13200:3000 -p 13201:3001 -p 18201:8001 \
  ...
  ' || true
  echo "Started. Web VNC: http://$(hostname -I | awk '{print $1}'):13200  (mt5 / mt5pass)"
...
status() {
  ...
  echo "VNC: http://$(hostname -I | awk '{print $1}'):13200  user=mt5 pass=mt5pass"
