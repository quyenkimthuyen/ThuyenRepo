...
def _slice_compare_ohlc(
  ...
  *,
  ...
  if frame is not None and len(frame) > limit:
    # Empty early window (New Year) should show the start of the run, not August.
