...
HELP = {
  ...
  "train_months": "Số tháng dữ liệu gần nhất để **mine chiến lược** trước mỗi kỳ OOS (walk-forward).",
  "reopt_period": "**Tuần**: mine lại mỗi tuần (bám thị trường, thường lợi nhuận cao hơn). "
                  "**Tháng**: mine 1 lần/tháng (ít overfit, drawdown thường thấp hơn).",
  "max_hold": "Số bar H1 tối đa giữ lệnh — **24** (ổn định, DD thấp) sau A/B.",
  "min_bars": "Khoảng cách tối thiểu giữa hai entry — **4 bars** sau A/B.",
  "trail_hybrid": "Trail sau khi lời ≥ act R, SL cách đỉnh dist R — **1.0 / 0.5** (mode ổn định).",
  ...
  "walk_forward": "Học trên data gần → trade kỳ OOS tiếp theo → lặp lại (tuần hoặc tháng, tránh nhìn trước tương lai).",
