...
|---------|----------|--------|
| `DEFAULT_PAIR` | `GBP/USD` | Cặp tiền duy nhất |
...
Cache giá: `data/gbpusd_h1.parquet` (+ `data/gbpusd_h1_meta.json`).
...
|---------|----------|--------|--------|
| `DEFAULT_SPREAD_PIPS` | `1.0` | pip | Chênh lệch mua/bán (0.0001 GBP/USD) |
