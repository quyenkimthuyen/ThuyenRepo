# ForexForge — GBP/USD H1 Self-Learning Trading System

Hệ thống backtest walk-forward + self-learning cho **GBP/USD khung H1** (Dukascopy 2022+).
...
data/gbpusd_h1.parquet       # Cache giá Dukascopy
...
**Tài liệu tham số đầy đủ:** [PARAMS.md](PARAMS.md) — profile đã lock, miner grids, GUI settings, MT5 export.
