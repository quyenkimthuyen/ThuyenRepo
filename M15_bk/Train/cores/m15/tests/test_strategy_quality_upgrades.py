...
def test_app_settings_default_mining_preset():
  ...
  assert DEFAULT_SETTINGS["oos_window_keys"] == ["2026", "2025-h2"]
  ...
  assert [w["key"] for w in cleaned["oos_windows"]] == ["2026", "2025-h2"]
...
def test_g23_fill_aware_defaults(monkeypatch):
  ...
  assert s["oos_window_keys"] == ["2026", "2025-h2"]
  assert [w["key"] for w in s["oos_windows"]] == ["2026", "2025-h2"]
