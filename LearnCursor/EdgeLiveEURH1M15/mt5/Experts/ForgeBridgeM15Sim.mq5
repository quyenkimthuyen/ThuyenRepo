...
input string InpBridgeSubdir   = "bridge_sim_m15";    // under MQL5/Files/ (SIM HistoryFeed)
...
int OnInit()
{
   ...
   else
   {
      ...
      Print("ForgeBridgeM15 Live | Files/", InpBridgeSubdir, " | magic=", InpMagic);
   }
