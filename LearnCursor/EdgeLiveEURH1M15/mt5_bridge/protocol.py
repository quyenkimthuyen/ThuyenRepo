...
Default module globals point at M15 live for back-compat. Prefer
runtime_profiles.get_profile(tf, mode).bridge_dir for dual-TF code.
"""
...
BRIDGE_H1_DIR = get_profile("H1", "live").bridge_dir
BRIDGE_SIM_H1_DIR = get_profile("H1", "sim").bridge_dir
...
DEFAULT_MODEL_ID = ""
DEFAULT_MAGIC = get_profile("M15", "live").magic
DEFAULT_SIM_MAGIC = get_profile("M15", "sim").magic
DEFAULT_H1_MAGIC = get_profile("H1", "live").magic
DEFAULT_H1_SIM_MAGIC = get_profile("H1", "sim").magic
DEFAULT_TIMEFRAME = "M15"
INSTANCE_ID = "M15"


def bridge_dir_for(tf: str, mode: str = "live") -> Path:
  return get_profile(tf, mode).bridge_dir
