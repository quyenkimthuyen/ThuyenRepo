...
def apply_best_to_profile(row: dict, *, run_id: str | None = None):
  from gui.trade_profile import apply_grid_row_to_active
  apply_grid_row_to_active(row, run_id=run_id)
...
def apply_best_as_new_trade_profile(row: dict, *, run_id: str | None = None, label: str | None = None):
  from gui.trade_profile import apply_grid_row_as_new_profile
  return apply_grid_row_as_new_profile(row, run_id=run_id, label=label)
