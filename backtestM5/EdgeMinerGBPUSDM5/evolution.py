...
# M5 hybrid pools: hold 8h–24h; spacing 40m–2h (denser than M15 3h → more trades)
TF_MAX_HOLD_BARS = (96, 144, 192, 288)
TF_MIN_BARS_BETWEEN = (8, 12, 16, 24)
M15_MAX_HOLD_BARS = TF_MAX_HOLD_BARS  # back-compat alias
M15_MIN_BARS_BETWEEN = TF_MIN_BARS_BETWEEN
