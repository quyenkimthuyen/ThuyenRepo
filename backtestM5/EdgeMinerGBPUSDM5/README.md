...
> với model M15 và không được dùng cho live. Live/Simulate chỉ dùng `ForgeBridgeM5G33.mq5`.
...
M5G33: app `8731` · Bridge `8995` · Sim chart `9106` · Compare `9216`
(port `8996` legacy paper-chart — không dùng). Folder `bridge_m5g33`, Magic `20261023`.
