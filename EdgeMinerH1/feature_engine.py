...
_PROFILE_ALIASES = {"existing": "current", "slower": "h1_native", "m15_native": "h1_native"}
...
class FeatureMatrix:
  ...
  def _build(self):
    ...
    if p.causal_h4:
      # Label each H4 aggregate at its close. Thus an H1 bar can only inherit
      # an H4 value after all H1 bars in that H4 candle have closed.
