...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15B5.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15B5Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15b5"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15b5"
$BridgeSubdirLive = "bridge_m15b5"
$BridgeSubdirSim = "bridge_sim_m15b5"
$EaNameLive = "ForgeBridgeM15B5"
$EaNameSim = "ForgeBridgeM15B5Sim"
$EaFolder = "EdgeMinerM15B5"
$EaMagicLive = 20261005
$EaMagicSim = 20262005
$IsBoth = ($Mode -eq "Both")
...
function New-EurusdM15Chart([string]$DataPath) {
  ...
  if ($templates.Count -eq 0) {
    ...
    $forgeExpertPattern = '(?s)<expert>\s*name=(?:ForgeBridgeM15B5Sim|ForgeBridgeM15B5|ForgeBridgeM15Sim|ForgeBridgeM15|ForgeBridgeH1Sim|ForgeBridgeH1|ForgeBridge)\b.*?</expert>\s*'
...
function Get-ForgeFamilyPattern {
  return 'name=(?:ForgeBridgeM15B5Sim|ForgeBridgeM15B5|ForgeBridgeM15Sim|ForgeBridgeM15|ForgeBridgeH1Sim|ForgeBridgeH1|ForgeBridge)\b'
}
...
function Restart-BridgeService {
  ...
  $commandLine = (
    ...
    "--monitor-port 8815 --bridge-dir `"$ProjectBridge`""
  )
