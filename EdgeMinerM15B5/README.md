> **Clone `B5`** từ EdgeMinerM15 — instance `M15B5` · app/bridge/paper `8551/8815/8816` · folder `bridge_m15b5` · magic `20261005`.
...
M15B5 dùng app/Bridge/Paper `8551/8815/8816`, folder `bridge_m15b5`, Magic `20261005`.
...
App mặc định mở tại `http://127.0.0.1:8551`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
