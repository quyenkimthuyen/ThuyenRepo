...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15A7.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15A7Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15a7"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15a7"
$BridgeSubdirLive = "bridge_m15a7"
$BridgeSubdirSim = "bridge_sim_m15a7"
$EaNameLive = "ForgeBridgeM15A7"
$EaNameSim = "ForgeBridgeM15A7Sim"
$EaFolder = "EdgeMinerM15A7"
$EaMagicLive = 20261007
$EaMagicSim = 20262007
$IsBoth = ($Mode -eq "Both")
...
function Restart-BridgeService {
  ...
  $commandLine = (
    ...
    "--monitor-port 8835 --bridge-dir `"$ProjectBridge`""
  )
