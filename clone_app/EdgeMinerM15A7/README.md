> **Clone `A7`** từ EdgeMinerM15 — instance `M15A7` · app/bridge/paper/sim/compare `8571/8835/8836/8946/9056` · folder `bridge_m15a7` · magic `20261007`.
...
M15A7 dùng app/Bridge/Paper/Sim/Compare `8571/8835/8836/8946/9056`, folder `bridge_m15a7`, Magic `20261007`.
...
App mặc định mở tại `http://127.0.0.1:8571`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
