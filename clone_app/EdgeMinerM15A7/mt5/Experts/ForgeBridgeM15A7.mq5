//+------------------------------------------------------------------+
//| ForgeBridgeM15A7.mq5 — EdgeMiner M15A7 (magic 20261007, bridge_m15a7)       |
...
input string InpBridgeSubdir   = "bridge_m15a7";          // under MQL5/Files/ (use bridge_sim for HistoryFeed)
