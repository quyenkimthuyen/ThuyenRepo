> **Clone `J9`** từ EdgeMinerM15 — instance `M15J9` · app/bridge/paper/sim/compare `8591/8855/8856/8966/9076` · folder `bridge_m15j9` · magic `20261009`.

# ForexForge — USD/JPY M15 Self-Learning Trading System

Hệ thống backtest walk-forward + self-learning cho **USD/JPY khung M15**, dùng thống nhất dữ liệu broker từ ForgeBridge/XM MT5.
...
M15J9 dùng app/Bridge/Paper/Sim/Compare `8591/8855/8856/8966/9076`, folder `bridge_m15j9`, Magic `20261009`.
...
App mặc định mở tại `http://127.0.0.1:8591`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
...
data/mt5_usdjpy_m15.parquet  # Cache M15 chuẩn từ ForgeBridge/XM MT5
