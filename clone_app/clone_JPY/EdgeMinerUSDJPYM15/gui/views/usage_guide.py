...
**ForexForge** là hệ thống backtest & self-learning cho **USD/JPY khung M15**, gồm:
...
| Bước | Mô tả |
|------|--------|
| 1 | ForgeBridge đồng bộ **USD/JPY M15** từ XM MT5 → cache `data/mt5_usdjpy_m15.parquet` |
...
- Một pair / một timeframe (USD/JPY M15)
