//+------------------------------------------------------------------+
//| ForgeBridgeM15A6Sim.mq5 — EdgeMiner M15A6 SIM (magic 20262006, bridge_sim_m15a6) |
...
input string InpBridgeSubdir   = "bridge_sim_m15a6";    // under MQL5/Files/ (SIM HistoryFeed)
