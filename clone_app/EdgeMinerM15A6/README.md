> **Clone `A6`** từ EdgeMinerM15 — instance `M15A6` · app/bridge/paper/sim/compare `8561/8825/8826/8936/9046` · folder `bridge_m15a6` · magic `20261006`.
...
M15A6 dùng app/Bridge/Paper/Sim/Compare `8561/8825/8826/8936/9046`, folder `bridge_m15a6`, Magic `20261006`.
...
App mặc định mở tại `http://127.0.0.1:8561`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
