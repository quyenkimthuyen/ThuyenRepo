...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15A6.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15A6Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15a6"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15a6"
$BridgeSubdirLive = "bridge_m15a6"
$BridgeSubdirSim = "bridge_sim_m15a6"
$EaNameLive = "ForgeBridgeM15A6"
$EaNameSim = "ForgeBridgeM15A6Sim"
$EaFolder = "EdgeMinerM15A6"
$EaMagicLive = 20261006
$EaMagicSim = 20262006
$IsBoth = ($Mode -eq "Both")
...
function Restart-BridgeService {
  ...
  $commandLine = (
    ...
    "--monitor-port 8825 --bridge-dir `"$ProjectBridge`""
  )
