> **Clone `C13`** từ EdgeMinerM15 — instance `M15C13` · app/bridge/paper/sim/compare `8631/8895/8896/9006/9116` · folder `bridge_m15c13` · magic `20261013`.

# ForexForge — BTC/USD M15 Self-Learning Trading System

Hệ thống backtest walk-forward + self-learning cho **BTC/USD khung M15**, dùng thống nhất dữ liệu broker từ ForgeBridge/XM MT5.
...
M15C13 dùng app/Bridge/Paper/Sim/Compare `8631/8895/8896/9006/9116`, folder `bridge_m15c13`, Magic `20261013`.
...
App mặc định mở tại `http://127.0.0.1:8631`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
