//+------------------------------------------------------------------+
//| ForgeBridgeM15A8.mq5 — EdgeMiner M15A8 (magic 20261008, bridge_m15a8)       |
...
input string InpBridgeSubdir   = "bridge_m15a8";          // under MQL5/Files/ (use bridge_sim for HistoryFeed)
