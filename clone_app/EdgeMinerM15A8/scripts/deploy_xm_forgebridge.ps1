...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15A8.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15A8Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15a8"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15a8"
$BridgeSubdirLive = "bridge_m15a8"
$BridgeSubdirSim = "bridge_sim_m15a8"
$EaNameLive = "ForgeBridgeM15A8"
$EaNameSim = "ForgeBridgeM15A8Sim"
$EaFolder = "EdgeMinerM15A8"
$EaMagicLive = 20261008
$EaMagicSim = 20262008
$IsBoth = ($Mode -eq "Both")
...
function Restart-BridgeService {
  ...
  $commandLine = (
    ...
    "--monitor-port 8845 --bridge-dir `"$ProjectBridge`""
  )
