> **Clone `A8`** từ EdgeMinerM15 — instance `M15A8` · app/bridge/paper/sim/compare `8581/8845/8846/8956/9066` · folder `bridge_m15a8` · magic `20261008`.
...
M15A8 dùng app/Bridge/Paper/Sim/Compare `8581/8845/8846/8956/9066`, folder `bridge_m15a8`, Magic `20261008`.
...
App mặc định mở tại `http://127.0.0.1:8581`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
