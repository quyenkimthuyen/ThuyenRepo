> **Clone `G14`** từ EdgeMinerM15 — instance `M15G14` · app/bridge/paper/sim/compare `8641/8905/8906/9016/9126` · folder `bridge_m15g14` · magic `20261014`.
...
M15G14 dùng app/Bridge/Paper/Sim/Compare `8641/8905/8906/9016/9126`, folder `bridge_m15g14`, Magic `20261014`.
...
App mặc định mở tại `http://127.0.0.1:8641`. Có thể đổi cổng bằng `-Port 8502` (Windows) hoặc `--port 8502` (Linux).
