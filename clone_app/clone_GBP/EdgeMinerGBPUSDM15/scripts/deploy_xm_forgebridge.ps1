...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15G14.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15G14Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15g14"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15g14"
$BridgeSubdirLive = "bridge_m15g14"
$BridgeSubdirSim = "bridge_sim_m15g14"
$EaNameLive = "ForgeBridgeM15G14"
$EaNameSim = "ForgeBridgeM15G14Sim"
$EaFolder = "EdgeMinerM15G14"
$EaMagicLive = 20261014
$EaMagicSim = 20262014
$IsBoth = ($Mode -eq "Both")
...
function Restart-BridgeService {
  ...
  $commandLine = (
    ...
    "--monitor-port 8905 --bridge-dir `"$ProjectBridge`""
  )
