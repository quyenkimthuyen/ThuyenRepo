...
def desk_pair_code() -> str:
  ...
  # 1) Authoritative desk config (clone-safe)
  try:
  ...
  # 2) Folder name: EdgeMinerGBPUSDM15 / EdgeMinerGBPUSDM5
  try:
  ...
  # 3) INSTANCE_ID — lab codes (M15G23) and Final_app codes (M15F2/M5F4 = GBP)
  try:
