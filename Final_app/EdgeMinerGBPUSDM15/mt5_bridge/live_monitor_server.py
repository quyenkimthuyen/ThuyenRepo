...
def _chart_html(max_bars: int, *, mode: str = "mt5", poll_ms: int = 2000) -> str:
  ...
  if compare_mode:
    chart_title = "GBPUSD M15 · Compare Trade"
    labels = (
    ...
    chart_title = "GBPUSD M15 · Simulate History Feed"
    labels = (
    ...
    chart_title = "GBPUSD M15 · Paper Trade"
    ...
    chart_title = "GBPUSD M15 · XM MT5 live"
    labels = (
