> **Backtest desk `G23`** — instance `M15F2` · app `8731` · Bridge `8995` · Sim `9106` · Compare `9216`
> (port `8996` = legacy Paper Monitor chart — desk đã gỡ) · folder `bridge_m15f2` · magic `20261521`.
...
> với model M15 và không được dùng cho live. Live/Simulate chỉ dùng `ForgeBridgeM15F2.mq5`.
...
M15F2: app `8731` · Bridge `8995` · Sim chart `9106` · Compare `9216`
(port `8996` legacy paper-chart — không dùng). Folder `bridge_m15f2`, Magic `20261521`.
...
data/mt5_gbpusd_m15.parquet  # Cache M15 chuẩn từ ForgeBridge/XM MT5
