...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15F2.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15F2Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15f2"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15f2"
$BridgeSubdirLive = "bridge_m15f2"
$BridgeSubdirSim = "bridge_sim_m15f2"
$EaNameLive = "ForgeBridgeM15F2"
$EaNameSim = "ForgeBridgeM15F2Sim"
$EaFolder = "EdgeMinerM15F2"
$EaMagicLive = 20261521
$EaMagicSim = 20262521
$IsBoth = ($Mode -eq "Both")
