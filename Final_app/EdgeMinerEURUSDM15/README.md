...
> với model M15 và không được dùng cho live. Live/Simulate chỉ dùng `ForgeBridgeM15F1.mq5`.
...
Folder `bridge_m15f1`, Magic `20261501`. H1 dùng `8502/8865/8866`, folder `bridge_h1`, Magic `20260725`.
