...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15F1.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM15F1Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m15f1"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m15f1"
$BridgeSubdirLive = "bridge_m15f1"
$BridgeSubdirSim = "bridge_sim_m15f1"
$EaNameLive = "ForgeBridgeM15F1"
$EaNameSim = "ForgeBridgeM15F1Sim"
$EaFolder = "EdgeMinerM15F1"
$EaMagicLive = 20261501
$EaMagicSim = 20262501
$IsBoth = ($Mode -eq "Both")
...
function Get-ForgeFamilyPattern {
  ...
  # ForgeBridgeM15F1\b does not match ForgeBridgeM15F1B4 — must use the open suffix.
