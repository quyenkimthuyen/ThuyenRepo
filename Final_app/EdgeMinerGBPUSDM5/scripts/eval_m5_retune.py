...
def _jobs() -> list[dict]:
  """Focused matrix aligned to prior GBP models (era_2025_2026_6thang)."""
  return [
    {
      "name": "baseline_tw6_era626",
      "preset": "baseline",
      "train_weeks": 6,
    ...
    {
      "name": "elite_or_quality_tw6_era626",
    ...
    {
      "name": "elite_or_quality_tw3_era626",
      "preset": "elite_or_quality",
      "train_weeks": 3,
      "kb_profile": "era_2025_2026_6thang",
      "use_kb": True,
    ...
    # Old sparse elite TPW under NEW fitness.
    {
      "name": "elite_or_legacy_tpw8_tw6_era626",
      "preset": "elite_or_quality",
      "train_weeks": 6,
      "kb_profile": "era_2025_2026_6thang",
      "use_kb": True,
