"""Canonical GBP/USD M5 loader backed exclusively by ForgeBridge/MT5."""
...
def load_gbpusd_m15(
  ...
  """Load canonical MT5 GBP/USD M5 data."""
  return download_gbpusd_m15(
    start_date, end_date, use_cache, force_refresh,
  ).dropna()


# Back-compat aliases (call sites still import load_eurusd_m15)
download_eurusd_m15 = download_gbpusd_m15
load_eurusd_m15 = load_gbpusd_m15
