> **M5 desk `E31`** — `M5F3` · app/bridge/sim/compare `8811/9075/9186/9296` · folder `bridge_m5f3` · magic `20261541` · cloned from M15 `EdgeMinerEURUSDM15`.
...
> với model M15 và không được dùng cho live. Live/Simulate chỉ dùng `ForgeBridgeM5F3.mq5`.
...
Folder `bridge_m5f3`, Magic `20261021`. H1 dùng `8502/8865/8866`, folder `bridge_h1`, Magic `20260725`.
