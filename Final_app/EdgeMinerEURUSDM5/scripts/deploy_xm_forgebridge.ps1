...
$SourceEaLive = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM5F3.mq5"
$SourceEaSim = Join-Path $RepoRoot "mt5\Experts\ForgeBridgeM5F3Sim.mq5"
$ProjectBridge = Join-Path $RepoRoot "mt5\bridge_m5f3"
$ProjectBridgeSim = Join-Path $RepoRoot "mt5\bridge_sim_m5f3"
$BridgeSubdirLive = "bridge_m5f3"
$BridgeSubdirSim = "bridge_sim_m5f3"
$EaNameLive = "ForgeBridgeM5F3"
$EaNameSim = "ForgeBridgeM5F3Sim"
$EaFolder = "EdgeMinerEURUSDM5"
$EaMagicLive = 20261541
$EaMagicSim = 20262541
$IsBoth = ($Mode -eq "Both")
