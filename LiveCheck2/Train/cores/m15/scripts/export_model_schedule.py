...
def main() -> int:
  ...
  spread = float((model or {}).get("spread_pips") or cfg.get("spread_pips") or DEFAULT_SPREAD_PIPS)
  slip = float((model or {}).get("slippage_pips") or cfg.get("slippage_pips") or DEFAULT_SLIPPAGE_PIPS)
  feature_profile = (
